...
class VehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'last_maintenance_mileage' => ['nullable', 'integer', 'min:0', 'max:2000000'],
            'next_maintenance_date' => ['nullable', 'date'],
            'maintenance_reminder_days' => ['nullable', 'integer', 'min:1', 'max:90'],
            'maintenance_source' => ['nullable', 'string', Rule::in(['calculated', 'manual'])],
