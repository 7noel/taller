                ...
                <div class="p-6">
                    <div class="mb-4">
                        <div class="relative max-w-md">
                            ...
                            <input type="text" id="party-search" placeholder="Buscar por nombre, razón social o documento..." class="search-input">
                        </div>
                    </div>
                    <div id="party-table" class="data-table"></div>
                </div>
            </div>
        </div>
    </div>
                ...
                { title: 'Email', field: 'email', minWidth: 180 },
                {
                    ...
                    formatter: function(cell) {
                        ...
                        return `<div class="flex gap-2 justify-center">
                            <a href="/parties/${id}" title="Ver contacto" class="btn-icon btn-icon-blue">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                            </a>
                            <a href="/parties/${id}/edit" title="Editar contacto" class="btn-icon btn-icon-amber">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
