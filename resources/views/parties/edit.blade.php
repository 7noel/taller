<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Editar Contacto de Vehículo') }}
        </h2>
    </x-slot>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select id="document_type" name="document_type" required
                                    ...
                                    <option value="1" @selected(old('document_type', $party->document_type) == '1')>DNI</option>
                                    <option value="6" @selected(old('document_type', $party->document_type) == '6')>RUC</option>
                                    <option value="4" @selected(old('document_type', $party->document_type) == '4')>Carné de Extranjería</option>
                                    <option value="7" @selected(old('document_type', $party->document_type) == '7')>Pasaporte</option>
                                    <option value="A" @selected(old('document_type', $party->document_type) == 'A')>Cédula Diplomática</option>
                                </select>
...
<input type="text" id="address" name="address" value="{{ old('address', $party->address) }}"
                            ...
                            <div class="md:col-span-2 flex items-center gap-2">
                                <input type="checkbox" id="is_supplier" name="is_supplier" value="1"
                                       class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500"
                                       @checked(old('is_supplier', $party->is_supplier))>
