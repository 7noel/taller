<x-app-layout>
                ...
                <div class="p-4 sm:p-5">
                    <div class="mb-3">
                        <div class="relative max-w-md">
                            ...
                            <input type="text" id="catalog-search" placeholder="Buscar..." class="search-input">
                        </div>
                    </div>
                    <div id="catalog-table" class="data-table"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    @push('scripts')
    <script>
        const table = new Tabulator('#catalog-table', {
            ...
            columns: [
                { title: 'Nombre', field: 'name', minWidth: 200 },
                {
                    ...
                    formatter: cell => cell.getValue()
                        ? '<span class="px-2 py-0.5 rounded-full text-xs font-medium bg-green-50 text-green-700">Activo</span>'
                ...
                },
                {
                    ...
                    formatter: function(cell) {
                        ...
                        return `<div class="flex gap-2 justify-center">
                            <a href="{{ $routePrefix }}/${id}/edit" title="Editar" class="btn-icon btn-icon-amber">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                </svg>
                            </a>
                            <form method="POST" action="{{ $routePrefix }}/${id}" class="inline" data-confirm="¿Eliminar este registro?">
                                @csrf @method('DELETE')
