<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('estimates.update', $estimate) }}">
                @csrf
                @method('PUT')
                @include('estimates._form', ['estimate' => $estimate, 'checkIn' => null, 'advisors' => $advisors, 'establishment' => $establishment])
    ...
    @include('estimates._form-scripts', ['estimate' => $estimate, 'checkIn' => null, 'establishment' => $establishment])
</x-app-layout>