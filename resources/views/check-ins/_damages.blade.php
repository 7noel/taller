...
<div class="border-b border-gray-200 pb-6 mb-6">
    ...
    <div class="flex flex-wrap gap-2 mb-4">
        ...
        <button type="button" data-type="crack" class="damage-tool-btn inline-flex items-center px-3 py-1.5 rounded-md text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700">🔵 Quebre</button>
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-4">
        ...
        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700">Tipo (sin imagen)</label>
                <select id="damage-type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    @foreach (\App\Models\CheckInDamage::DAMAGE_TYPE_LABELS as $value => $label)
    ...
    <div class="mt-4">
        ...
        <div id="damage-list" class="space-y-2">
            @foreach ($initialDamages as $index => $damage)
                <div class="damage-row bg-gray-50 border border-gray-200 rounded-lg p-3 flex flex-wrap items-center gap-3">
