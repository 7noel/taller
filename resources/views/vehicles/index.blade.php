                ...
                <div class="p-4 sm:p-5">
                    <div class="mb-3">
                        <div class="relative max-w-md">
                            ...
                            <input type="text" id="vehicle-search" placeholder="Buscar por placa, marca, modelo o propietario..." class="search-input">
                        </div>
                    </div>
                    <div id="vehicle-table" class="data-table"></div>
                </div>
            </div>
        </div>
    </div>
                ...
                { title: 'Año', field: 'year', width: 80, hozAlign: 'center' },
                {
                    ...
                    formatter: function(cell) {
                        ...
                        return `<div class="flex gap-2 justify-center">
                            <a href="/vehicles/${id}" title="Ver vehículo" class="btn-icon btn-icon-blue">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                            </a>
                            <a href="/vehicles/${id}/edit" title="Editar vehículo" class="btn-icon btn-icon-amber">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                </svg>
                            </a>
                            <form method="POST" action="/vehicles/${id}" class="inline" data-confirm="¿Eliminar este vehículo?">
                                @csrf @method('DELETE')
                                <button type="submit" title="Eliminar vehículo" class="btn-icon btn-icon-red">
                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
