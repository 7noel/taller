<x-app-layout>
                    ...
                    <form method="POST" action="{{ route('vehicles.update', $vehicle) }}" id="vehicle-form">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="plate" name="plate" value="{{ old('plate', $vehicle->plate) }}" required maxlength="7"
                                       placeholder="ABC123"
    ...
    <script>
        ...
        @php
            $existingRelationshipsData = $vehicle->relationships->map(fn ($rel) => [
        ...
        @endphp
        const existingRelationships = @json($existingRelationshipsData);
