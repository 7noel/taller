<x-app-layout>
                    ...
                    <form method="POST" action="{{ route('vehicles.store') }}" id="vehicle-form">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" id="next_technical_review_date" name="next_technical_review_date" value="{{ old('next_technical_review_date') }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="technical_review_reminder_days" name="technical_review_reminder_days" value="{{ old('technical_review_reminder_days', 15) }}" min="1" max="90"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
    ...
    <script>
        ...
        function addRelationshipRow(party = null, role = '', isPrimary = false, notes = '') {
            relationshipCount++;
            ...
            div.innerHTML = `
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="relationships[${index}][notes]" value="${notes}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Opcional">
                    </div>
        ...
        document.getElementById('save-party-btn').addEventListener('click', function() {
            ...
            .then(({ ok, json }) => {
                ...
                // Agregar relación con la party creada
